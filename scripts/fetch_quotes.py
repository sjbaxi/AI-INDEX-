#!/usr/bin/env python3
"""
Fetches current quotes for the NSE AI Index constituents (defined once in
base.json -- see establish_base.py) and writes data.json: per-company price,
change %, market cap in Rs crore, screening note/confidence, PLUS the
market-cap-weighted index level and its change from the previous close.
