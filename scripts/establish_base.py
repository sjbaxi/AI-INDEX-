#!/usr/bin/env python3
"""
Establishes the base for a market-cap-weighted NSE AI Index, base date
1 April 2023, base value 1000 -- same construction as the logistics index:
...
to rebalance (change constituents, refresh share counts).

Most constituents here IPO'd after 1 April 2023 (this is a young sector on
NSE), so their "base price" is a first-trade-day proxy, not an actual
2023 price -- see baseIsProxy in the output.
"""
import json
import sys
import time
